...
<div id="page-container">
    ...
    <div id="content-wrap">
        <c:set var="pathWithTestUuid" scope="session"
               value="${pageContext.request.contextPath}/admins/questions/question/new?test_uuid=${test_uuid}"/>
        <c:set var="pathWithoutTestUuid" scope="session"
               value="${pageContext.request.contextPath}/admins/questions/question/new"/>
