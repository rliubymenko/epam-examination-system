...
public class CreateQuestionForTestCommand implements ActionCommand {
    ...
    public CommandResult execute(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            Set<String> inconsistencies = performValidation(content, type);
            ...
            if (questionService.create(question)) {
                LOG.debug("The subject {} has been created successfully", question);
                Optional<QuestionDto> createdQuestion = questionService.findByTestUuid(UUID.fromString(testUuid));
                if (createdQuestion.isPresent()) {
                    answerService.createAnswersForQuestion(answers, createdQuestion.get());
                    LOG.debug("The answers {} has been created successfully for question {}", answers, createdQuestion);
                }
    ...
    private Set<String> performValidation(String content, String type) {
    ...
    private List<AnswerDto> extractAnswers(HttpServletRequest request, String type) {
        ...
        switch (type) {
            ...
            case "single_choice" -> {
                ...
                if (ArrayUtils.isNotEmpty(singleChoiceAnswers)) {
            ...
            case "multiple_choice" -> {
                ...
                if (ArrayUtils.isNotEmpty(multipleChoiceAnswers)) {
